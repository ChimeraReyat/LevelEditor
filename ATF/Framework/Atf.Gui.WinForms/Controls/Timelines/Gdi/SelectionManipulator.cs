...
{
    /// <summary>
    /// OBSOLETE. Please use the much faster D2dSelectionManipulator in the Sce.Atf.Controls.Timelines.Direct2D namespace.
    /// A timeline manipulator for implementing the selection logic. Should probably be attached
    /// last to the TimelineControl. The attachment is permanent and there must be one
    /// TimelineControl per ITimelineDocument.</summary>
    ...
    public class SelectionManipulator
    {
        ...
        /// <summary>
        /// Event handler for the TimelineControl.KeyDown event to handle Shift+End and Shift+Home</summary>
        /// <param name="sender">The TimelineControl that we are attached to</param>
        ...
        /// <summary>
        /// Handles selecting an event (e.g., IKey, IMarker, IInterval), taking into account
        /// selecting ranges of tracks</summary>
        /// <param name="target">TimelinePath</param>
        ...
        /// <summary>
        /// The TimelineControl that this manipulator is permanently attached to. There is one
        /// TimelineControl for each ITimelineDocument / selection set.</summary>
        protected readonly TimelineControl Owner;
