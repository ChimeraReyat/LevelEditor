...
namespace Sce.Atf.Controls.Timelines.Direct2D
{
    ...
    /// 2. If the handles on the scaling manipulator are dragged, the portion of the timeline
    ...
    public class D2dScaleManipulator
    {
        ...
        /// <summary>
        /// The timeline control that this scale manipulator is bound to, listening to its events</summary>
        public readonly D2dTimelineControl Owner;

        /// <summary>
        /// Gets or sets the height, in display units, of the manipulator handle</summary>
        [DefaultValue(24)]
        ...
        /// <summary>
        /// Gets the temporary object used per scaling operation. If this is not null, the user
        ...
        /// <summary>
        /// Gets how an interval or selection set is being resized. Can only be called
        /// if the IsScaling property is true.</summary>
        ...
        /// <summary>
        /// Enum indicating which scaling mode we are in</summary>
        protected enum ScaleMode
        {
            /// <summary>
            /// Only intervals are affected and their start positions remain pinned</summary>
            InPlace,
        ...
        /// <summary>
        /// Class whose instances are created for the duration of a scaling event. Is responsible for tracking the 'ghosts' and for
        /// doing the final update of the selected objects.</summary>
        protected class Resizer
        {
            /// <summary>
            /// Scaling mode are we in</summary>
            public readonly ScaleMode Mode;

            /// <summary>
            /// X-offset from the drag starting point, in world coordinates</summary>
            ...
            /// <summary>
            /// Gets minimum ghost x-coordinate in world coordinates</summary>
            ...
            /// <summary>
            /// Gets maximum ghost x-coordinate in world coordinates</summary>
            ...
            /// <summary>
            /// Resizes selection. CreateGhostInfo must be called first, although sometimes a MouseUp event happens
