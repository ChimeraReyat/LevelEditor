...
namespace Sce.Atf.Controls.Timelines.Direct2D
{
    ...
    /// interval, if the user holds down a modifier key (Alt by default), the cursor changes
    /// to indicate where a split will take place. On the MouseDown event, the interval will be
    /// split.</summary>
    public class D2dSplitManipulator
    {
        /// <summary>
        ...
        static D2dSplitManipulator()
        {
            s_snapOptions = new D2dTimelineControl.SnapOptions();
        ...
        private static readonly D2dTimelineControl.SnapOptions s_snapOptions;
    }
}
