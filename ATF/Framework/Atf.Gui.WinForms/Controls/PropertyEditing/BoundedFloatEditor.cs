...
{
    /// <summary>
    /// Bounded floats property editor that supplies BoundedFloatControl instances to embed in complex
    ...
    public class BoundedFloatEditor : UITypeEditor, IPropertyEditor, IAnnotatedParams
    {
        ...
        public void Initialize(string[] parameters)
        {
            ...
            if (parameters.Length < 2 ||
                !Single.TryParse(parameters[0], NumberStyles.Float, CultureInfo.InvariantCulture, out min) ||
                !Single.TryParse(parameters[1], NumberStyles.Float, CultureInfo.InvariantCulture, out max) ||
                min >= max)
            {
        ...
        protected class BoundedFloatControl : Sce.Atf.Controls.FloatInputControl, ICacheablePropertyControl
        {
            /// <summary>
            /// Constructor</summary>
            /// <param name="context">Context for property editing control</param>
