...
namespace Sce.Atf.Dom
{
    ...
    public class DomNodeQueryable : DomNodeAdapter, IQueryableContext, IQueryableResultContext, IQueryableReplaceContext
	{
        ...
        /// <summary>
        /// Compiles an enumeration of DomNode properties (as objects) which matched the conditions of the search predicates</summary>
		...
		private List<object> m_results =  new List<object>();
    }
}
