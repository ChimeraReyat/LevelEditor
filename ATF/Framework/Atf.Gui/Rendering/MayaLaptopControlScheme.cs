...
namespace Sce.Atf.Rendering
{
    ...
    /// to camera commands, similar to Maya camera controls, but tailored to
    /// a laptop that is lacking a middle mouse button and mouse wheel</summary>
    public class MayaLaptopControlScheme : ControlScheme
    {
        ...
        {
            return
                (e.Button == MouseButtons.Left && (modifierKeys & (Keys.Alt | Keys.Control)) == Keys.Alt);
        }
        ...
        {
            return
                (e.Button == MouseButtons.Middle && (modifierKeys & Keys.Alt) == Keys.None) ||
                (e.Button == MouseButtons.Left && (modifierKeys & (Keys.Alt | Keys.Control)) == Keys.Alt);
        }
